...
def install_rtt():
    ...
    if arch in ['x86_64', 'amd64']:
        rtt_download_url = "https://github.com/radkesvat/ReverseTlsTunnel/releases/download/V7.1/v7.1_linux_amd64.zip"
    elif arch in ['aarch64', 'arm64']:
        rtt_download_url = "https://github.com/radkesvat/ReverseTlsTunnel/releases/download/V7.1/v7.1_linux_arm64.zip"
    else:
